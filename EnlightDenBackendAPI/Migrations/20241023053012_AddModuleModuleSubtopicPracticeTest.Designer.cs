...
namespace EnlightDenBackendAPI.Migrations
{
    ...
    [Migration("20241023053012_AddModuleModuleSubtopicPracticeTest")]
    partial class AddModuleModuleSubtopicPracticeTest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnlightDenBackendAPI.Entities.Module", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<List<Guid>>("SubtopicIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
            ...
            modelBuilder.Entity("EnlightDenBackendAPI.Entities.ModuleSubtopic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ModuleSubtopics", "General");
                });
            ...
            modelBuilder.Entity("EnlightDenBackendAPI.Entities.PracticeTest", b =>
                {
                    ...
                    b.ToTable("PracticeTests", "General");
                });
            ...
            modelBuilder.Entity("EnlightDenBackendAPI.Entities.Module", b =>
                {
                    ...
                    b.HasOne("EnlightDenBackendAPI.Entities.Note", "Note")
                        .WithMany()
            ...
            modelBuilder.Entity("EnlightDenBackendAPI.Entities.ModuleSubtopic", b =>
                {
                    b.HasOne("EnlightDenBackendAPI.Entities.Module", "Module")
                        .WithMany("Subtopics")
